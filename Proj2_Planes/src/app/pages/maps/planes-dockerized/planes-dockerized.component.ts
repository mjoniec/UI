...
@Component({
  selector: 'ngx-planes-dockerized',
  styleUrls: ['./planes-dockerized.component.scss'],
  template: `
    <nb-card>
      <nb-card-header>Planes Dockerized</nb-card-header>
      <div echarts [options]="options" class="echarts"></div>
      <!--<img src = "assets/images/traffic.jpg" height="596" width="1000"/> -->
    </nb-card>
  `,
})
export class PlanesDockerizedMapComponent implements OnDestroy {
